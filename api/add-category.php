...
try {
    ...
    $newCategory = [
        'id' => $maxId + 1,
        'name' => $name,
        'position' => count($fullMenu['ristoranti'][$restaurantId]['categories']) + 1,
        'visible' => true,
        'products' => []
    ];

    // Aggiungi la categoria al menu del ristorante
    $fullMenu['ristoranti'][$restaurantId]['categories'][] = $newCategory;
