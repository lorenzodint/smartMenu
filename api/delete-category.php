...
try {
    ...
    // Trova e rimuovi la categoria
    $categoryFound = false;
    foreach ($fullMenu['ristoranti'][$restaurantId]['categories'] as $key => $category) {
        if ($category['id'] == $id) {
            unset($fullMenu['ristoranti'][$restaurantId]['categories'][$key]);
            $fullMenu['ristoranti'][$restaurantId]['categories'] = array_values($fullMenu['ristoranti'][$restaurantId]['categories']);
            $categoryFound = true;
            break;
        }
    }
